...
namespace Tests
{
    public class MoveTester
    {
        ...
        public void CheckRookPossibleTargetSquares()
        {
            ...
            Assert.Equal(_whiteQueenSideRookExpectedTargets, MoveValidator.GetAllPossibleTargets(testBoard, 7, 0));

            // correct white king side rook moves
            Assert.Equal(_whiteKingSideRookExpectedTargets, MoveValidator.GetAllPossibleTargets(testBoard, 7, 7));

            // correct black queen side rook moves
            Assert.Equal(_blackQueenSideRookExpectedTargets, MoveValidator.GetAllPossibleTargets(testBoard, 0, 0));

            // correct black king side rook moves
            Assert.Equal(_blackKingSideRookExpectedTargets, MoveValidator.GetAllPossibleTargets(testBoard, 0, 7));
        }
        ...
        public void CheckKnightPossibleTargetSquares()
        {
            ...
            Assert.Equal(_whiteQueenSideKnightExpected, MoveValidator.GetAllPossibleTargets(testBoard, 7, 1));

            // correct white king side knight moves
            Assert.Equal(_whiteKingSideKnightExpected, MoveValidator.GetAllPossibleTargets(testBoard, 7, 6));

            // correct black queen side knight moves
            Assert.Equal(_blackQueenSideKnightExpected, MoveValidator.GetAllPossibleTargets(testBoard, 0, 1));

            // correct black king side knight moves
            Assert.Equal(_blackKingSideKnightExpected, MoveValidator.GetAllPossibleTargets(testBoard, 0, 6));
        }
        ...
        public void CheckBishopPossibleTargetSquares()
        {
            ...
            Assert.Equal(_whiteQueenSideBishopExpected, MoveValidator.GetAllPossibleTargets(testBoard, 7, 2));

            // correct white king side bishop moves
            Assert.Equal(_whiteKingSideBishopExpected, MoveValidator.GetAllPossibleTargets(testBoard, 7, 5));

            // correct black queen side bishop moves
            Assert.Equal(_blackQueenSideBishopExpected, MoveValidator.GetAllPossibleTargets(testBoard, 0, 2));

            // correct black king side bishop moves
            Assert.Equal(_blackKingSideBishopExpected, MoveValidator.GetAllPossibleTargets(testBoard, 0, 5));
        }
        ...
        public void CheckQueenPossibleTargetSquares()
        {
            ...
            Assert.Equal(_whiteQueenExpected, MoveValidator.GetAllPossibleTargets(testBoard, 7, 3));

            // correct black queen moves
            Assert.Equal(_blackQueenExpected, MoveValidator.GetAllPossibleTargets(testBoard, 0, 3));
        }
        ...
        public void CheckKingPossibleTargetSquares()
        {
            ...
            Assert.Equal(_whiteKingExpected, MoveValidator.GetAllPossibleTargets(testBoard, 7, 4));

            // correct black king moves
            Assert.Equal(_blackKingExpected, MoveValidator.GetAllPossibleTargets(testBoard, 0, 4));
        }
